...
const testPhotoScene = new Scenes.WizardScene('testPhotoWizard', department, problems, problemsDetails, urgency, roomNumber, conditionStep)
module.exports = testPhotoScene
